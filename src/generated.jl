...
export ADD,ALT,ARROW_DOWN,ARROW_LEFT,ARROW_RIGHT,ARROW_UP,BACKSPACE,BACK_SPACE,CANCEL,CLEAR,COMMAND,CONTROL,DECIMAL,DELETE,DIVIDE,DOWN,END,ENTER,EQUALS,ESCAPE,F1,F10,F11,F12,F2,F3,F4,F5,F6,F7,F8,F9,HELP,HOME,INSERT,LEFT,LEFT_ALT,LEFT_CONTROL,LEFT_SHIFT,META,MULTIPLY,NULL,NUMPAD0,NUMPAD1,NUMPAD2,NUMPAD3,NUMPAD4,NUMPAD5,NUMPAD6,NUMPAD7,NUMPAD8,NUMPAD9,PAGE_DOWN,PAGE_UP,PAUSE,RETURN,RIGHT,SEMICOLON,SEPARATOR,SHIFT,SPACE,SUBTRACT,TAB,UP

ks = pyimport("selenium.webdriver.common.keys")
const ADD = ks.Keys.ADD
const ALT = ks.Keys.ALT
const ARROW_DOWN = ks.Keys.ARROW_DOWN
const ARROW_LEFT = ks.Keys.ARROW_LEFT
const ARROW_RIGHT = ks.Keys.ARROW_RIGHT
const ARROW_UP = ks.Keys.ARROW_UP
const BACKSPACE = ks.Keys.BACKSPACE
const BACK_SPACE = ks.Keys.BACK_SPACE
const CANCEL = ks.Keys.CANCEL
const CLEAR = ks.Keys.CLEAR
const COMMAND = ks.Keys.COMMAND
const CONTROL = ks.Keys.CONTROL
const DECIMAL = ks.Keys.DECIMAL
const DELETE = ks.Keys.DELETE
const DIVIDE = ks.Keys.DIVIDE
const DOWN = ks.Keys.DOWN
const END = ks.Keys.END
const ENTER = ks.Keys.ENTER
const EQUALS = ks.Keys.EQUALS
const ESCAPE = ks.Keys.ESCAPE
const F1 = ks.Keys.F1
const F10 = ks.Keys.F10
const F11 = ks.Keys.F11
const F12 = ks.Keys.F12
const F2 = ks.Keys.F2
const F3 = ks.Keys.F3
const F4 = ks.Keys.F4
const F5 = ks.Keys.F5
...
const F8 = ks.Keys.F8
const F9 = ks.Keys.F9
const HELP = ks.Keys.HELP
const HOME = ks.Keys.HOME
const INSERT = ks.Keys.INSERT
const LEFT = ks.Keys.LEFT
const LEFT_ALT = ks.Keys.LEFT_ALT
const LEFT_CONTROL = ks.Keys.LEFT_CONTROL
const LEFT_SHIFT = ks.Keys.LEFT_SHIFT
const META = ks.Keys.META
const MULTIPLY = ks.Keys.MULTIPLY
const NULL = ks.Keys.NULL
const NUMPAD0 = ks.Keys.NUMPAD0
const NUMPAD1 = ks.Keys.NUMPAD1
const NUMPAD2 = ks.Keys.NUMPAD2
const NUMPAD3 = ks.Keys.NUMPAD3
const NUMPAD4 = ks.Keys.NUMPAD4
const NUMPAD5 = ks.Keys.NUMPAD5
const NUMPAD6 = ks.Keys.NUMPAD6
const NUMPAD7 = ks.Keys.NUMPAD7
const NUMPAD8 = ks.Keys.NUMPAD8
const NUMPAD9 = ks.Keys.NUMPAD9
const PAGE_DOWN = ks.Keys.PAGE_DOWN
const PAGE_UP = ks.Keys.PAGE_UP
const PAUSE = ks.Keys.PAUSE
const RETURN = ks.Keys.RETURN
const RIGHT = ks.Keys.RIGHT
const SEMICOLON = ks.Keys.SEMICOLON
const SEPARATOR = ks.Keys.SEPARATOR
const SHIFT = ks.Keys.SHIFT
const SPACE = ks.Keys.SPACE
const SUBTRACT = ks.Keys.SUBTRACT
const TAB = ks.Keys.TAB
const UP = ks.Keys.UP
end
